...
function movimientoopcion5(){
	...
	if(numeroo5 >= 800) {numeroo5=0}else{numeroo5+=10}

    for (var i = 0; i <= numeroo5; i+=220) {
	  
	    if (numeroo5>=i) {ubicacionxo5 =i}
    }
    if (numero5>=800) {numero5=0} else {numero5+=5}
...
ctx.clearRect(ubicacion5,0,0,0);
...
ctx.drawImage(sprite, ubicacionxo5,0,155,355,ubicacion5,300,200,200);
